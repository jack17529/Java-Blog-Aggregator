            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                     ...
                     <!--   <li>
                        <a class="page-scroll" href="index1.jsp">Blog</a>
                    </li> -->
                    <li>
    ...
    <header>
        <div class="header-content" id="home">
            <div class="header-content-inner">
                <h1 id="homeHeading">STAR STALKER</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h1 class="section-heading">Quote</h1>
                    <hr class="light">
                    <p class="text-faded">Your content will go here </p>
                    <a href="#services" class="page-scroll btn btn-default btn-xl sr-button">Skills</a>
                </div>
            </div>
        </div>
    </section>
